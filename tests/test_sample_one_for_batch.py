...
class TestSampleOneForBatch(unittest.TestCase):
    def test_uses_xgb_hill_when_available(self):
        ...
        try:
            ...
            z = bu._sample_one_for_batch(LS(4), 'p', True, object(), steps=3, lr_mu=0.3, trust_r=None)
    ...
    def test_falls_back_to_around_prompt_when_no_xgb(self):
        ...
        z = bu._sample_one_for_batch(LS(4), 'p', False, None, steps=3, lr_mu=0.3, trust_r=None)
